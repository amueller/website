...
$(document).ready(function() {
	...
	var oTableQualities = $('#datatable_dataqualities').dataTable( {
		"bServerSide": true,
		"sAjaxSource": "api_query/table_feed",
		"sServerMethod": "POST",
		"fnServerParams": function ( aoData ) {
	...
	var oTableFeatures = $('#datatable_datafeatures').dataTable( {
		"bServerSide": true,
		"sAjaxSource": "api_query/table_feed",
		"sServerMethod": "POST",
		"fnServerParams": function ( aoData ) {
		  <?php echo array_to_parsed_string($this->dt_features, "aoData.push( { 'value': '[VALUE]', 'name' : '[KEY]' } );\n" ); ?>
		},
		"aoColumnDefs": [
		...
		"iDisplayLength" : 50,
		"bAutoWidth": false,
		<?php echo column_widths($this->dt_features['column_widths']); ?>
        "bPaginate": true,
    });
