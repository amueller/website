       ...
       <h2>Getting started</h2>
          ...
          <p>The REST Endpoint URL is <code class="http">http://www.openml.org/api_new/v1/</code></p>
          <p>The default endpoint returns data in XML. If you prefer JSON, use the endpoint <code class="http">http://www.openml.org/api_new/v1/json/</code><br>
       ...
       <p>For instance, you can call <code>/data/{id}</code>:<br>
         in XML: <a href="http://www.openml.org/api_new/v1/data/1">http://www.openml.org/api_new/v1/data/1</a><br>
         in JSON: <a href="http://www.openml.org/api_new/v1/json/data/1">http://www.openml.org/api_new/v1/json/data/1</a></p>
