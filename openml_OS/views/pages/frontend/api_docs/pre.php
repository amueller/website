<?php
  ...
  $this->api_spec = "https://raw.githubusercontent.com/openml/website/master/openml_OS/models/api/v1/swagger.json"; #default, should be latest version
  if(isset($this->subpage) and $this->subpage == 'v1'){
    $this->api_spec = "https://raw.githubusercontent.com/openml/website/master/openml_OS/models/api/v1/swagger.json";
  }
