/* Author: Joaquin Vanschoren, Jan N. van Rijn
...
$(function() {
  ...
  $( "#evaluationmetricDropdown" ).autocomplete({ source: evaluationmetrics, minLength: 1 });
});
