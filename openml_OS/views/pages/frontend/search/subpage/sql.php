<h3>SQL <small>compose and run</small></h3>
<div class="well" id="sqlbox"><textarea id="sql" name="sql"></textarea></div>
<div class="sqlmessage-buttonbox">
  <div class="sqlmessage"></div>
  <button id="sqlquery-btn" data-loading-text="Querying..." autocomplete="off" class="btn btn-info">Run Query</button>
</div>
  <h4 style="padding-top:30px;">Database schema <small>- Click tables for more info</small></h4>
    <div id="expdbschema">
