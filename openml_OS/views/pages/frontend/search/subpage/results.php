...
<?php if($this->filtertype and in_array($this->filtertype, array("data"))){?>
						<p class="searchstatdetail">Only showing <a data-toggle="collapse" href="#filterBox" aria-expanded="true" aria-controls="filterBox"><?php echo (array_key_exists('status',$this->filters) ? $this->filters['status'] : 'active');?></a> datasets.</p>
<?php } ?>
</div>
<?php } ?>
