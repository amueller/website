...
<ul class="nav nav-tabs" >
  ...
  <li class="<?php echo ($this->att == 'data_stream_classification') ? 'active' : '' ?>">
    <a href="#data_stream_classification" data-toggle="tab">Data Stream Classification</a>
  </li>
...
<div class="tab-content" >
  ...
  <div class="tab-pane <?php echo ($this->att == 'data_stream_classification') ? 'active' : '' ?>" id="data_stream_classification">
    <div class="bs-callout bs-callout-info">
      <h4>Supervised Data Stream Classification</h4>
      Given a huge, possibly infinite stream of non-stationary data, train a model that and return predictions for that model. 
    </div>
    <form class="form-horizontal" action="search/tab/tasktab" method="post">
