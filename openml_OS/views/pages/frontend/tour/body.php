...
<div id="myCarousel" class="carousel slide pause">
 ...
 <div class="col-md-5 pull-left" style="text-align:left">
      <h2><i class="fa fa-group"></i>  Open Science</h2>
      ...
      <h2><i class="fa fa-heart"></i>  Get noticed</h2>
      <p>Share 
 ...
 <div class="col-md-5 pull-left" style="text-align:left">
      <h2><i class="fa fa-bolt"></i> Jump-start your research</h2>
      ...
      <h2><i class="fa fa-trophy"></i> Advanced queries</h2>
 ...
 <div class="col-md-5 pull-left" style="text-align:left">
      <h2><i class="fa fa-magic"></i> Automatic sharing</h2>
...
to integrate OpenML in your tools or build your own plugins.</p>
 ...
 <div class="col-md-5 pull-left" style="text-align:left">
      <h2><i class="fa fa-check"></i> Tasks</h2>
 ...
 <div class="col-md-5 pull-left" style="text-align:left">
      ...
      <h2><i class="fa fa-book"></i> Beyond journals</h2>
	<p>In journals, experiments are static, summarized, and scattered. Here, they are linked together, up to date, and stored in full detail.</p></div>
  	...
  	<a class="left carousel-control" href="#myCarousel" data-slide="prev" style="background-image:none;color:#666"><i class="fa fa-chevron-left"></i></span></a>
	<a class="right carousel-control" href="#myCarousel" data-slide="next" style="background-image:none;color:#666"><i class="fa fa-chevron-right"></i></span></a>
</div></div>
</div>
