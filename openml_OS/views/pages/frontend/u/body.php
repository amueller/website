<div class="container-fluid topborder endless openmlsectioninfo">
  <div class="col-xs-12 col-md-10 col-md-offset-1" id="mainpanel">
    ...
    <div class="tab-content">
      <div class="tab-pane  <?php if(isset($this->usubpage)) { echo 'active'; } ?>" id="data">
        <?php
        subpage('data');
        ?>
      </div> <!-- end intro tab -->

      <div class="tab-pane <?php if(!isset($this->usubpage) and false !== strpos($_SERVER['REQUEST_URI'],'/u/')) { echo 'active'; }?>" id="userdetail">
        <?php
        subpage('user');
        ?>
    ...
    <div class="submenu">
      ...
      <ul class="sidenav nav" id="accordeon">
        <li class="panel guidechapter">
          ...
          <ul class="sidenav nav collapse in" id="pagelist">
            <li><a href="<?php echo $this->baseurl.'/data';?>">Data sets</a></li>
            <li><a href="<?php echo $this->baseurl.'/flows';?>">Flows</a></li>
            <li><a href="<?php echo $this->baseurl.'/runs';?>">Runs</a></li>
          </ul>
        </li>
      </ul>
    </div>
